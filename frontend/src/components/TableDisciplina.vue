...
export default {
  ...
  mounted() {
      ...
      for (let h = 1; h <= 12; h++) {
        ...
        for (let dia = 1; dia <= 5; dia++) {
          ...
          if (card) {
            ...
            var sala = this.salas[card.sala];
            var professor = this.professores[card.professor];
    ...
    this.axios
      .get("https://otime-api2.herokuapp.com/cards/", {
        params: {
      ...
      .then((response) => {
        ...
        this.axios
          .get("https://otime-api2.herokuapp.com/professores/")
          .then((response) => {
            this.professores = criarMap(response.data);
            this.axios
              .get("https://otime-api2.herokuapp.com/turmas/")
              .then((response) => {
                this.turmas = criarMap(response.data);
                this.axios
                  .get("https://otime-api2.herokuapp.com/salas/")
                  .then((response) => {
                    this.salas = criarMap(response.data);
                    this.axios
                      .get("https://otime-api2.herokuapp.com/disciplinas/" + disciplinaId + "/")
                      .then((response) => {
